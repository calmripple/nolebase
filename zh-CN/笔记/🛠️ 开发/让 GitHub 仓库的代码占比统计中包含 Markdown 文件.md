...
对于 知在 这样的使用 Git 作为版本管理和协作的知识库和其他众多的文档站点（比如 Kubernetes 文档站 [kubernetes/website](https://github.com/kubernetes/website)），默认配置的情况下，GitHub 可能会把仓库内的代码占比展示为下面这样：
...
上图是 知在 的主要仓库 [nolebase/nolebase](https://github.com/calmripple/nolebase) 的代码占比统计信息，可以看到在调整配置之后，知在 中的巨量 Markdown 文件就能被统计到占比中了。
