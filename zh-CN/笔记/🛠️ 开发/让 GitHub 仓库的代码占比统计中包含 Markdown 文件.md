...
对于 存在与知 这样的使用 Git 作为版本管理和协作的知识库和其他众多的文档站点（比如 Kubernetes 文档站 [kubernetes/website](https://github.com/kubernetes/website)），默认配置的情况下，GitHub 可能会把仓库内的代码占比展示为下面这样：
